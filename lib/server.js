...
export { init, sendStreamEvent, sendResponseEvent, sendCommandEvent };
export default { init, sendStreamEvent, sendResponseEvent, sendCommandEvent };
